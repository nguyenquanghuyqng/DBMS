...
INSERT INTO `listenaudio` VALUES (1,'audio1.wav  '),(2,'audio2.wav  '),(3,'audio3.wav  '),(4,'audio4.wav  '),(5,'audio5.wav  '),(6,'audio6.wav  '),(7,'audio7.wav  '),(8,'audio8.wav  '),(9,'audio9.wav  '),(10,'audio10.wav  ');
...
CREATE TABLE `reading` (
  ...
  KEY `Reading_Test` (`testid`),
  CONSTRAINT `Reading_ReadTest` FOREIGN KEY (`readtestid`) REFERENCES `readtest` (`readtestid`),
  CONSTRAINT `Reading_Test` FOREIGN KEY (`testid`) REFERENCES `test` (`testid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `result` (
  ...
  CONSTRAINT `Result_Test` FOREIGN KEY (`testid`) REFERENCES `test` (`testid`),
...
INSERT INTO `result` VALUES (1,40,20,60,1,1),(2,30,40,70,2,2),(3,10,20,30,3,3),(4,20,50,70,1,4),(5,30,60,90,2,5),(6,20,50,70,2,6);
...
INSERT INTO `test` VALUES (1,'Mini Test','20'),(2,'Medium Test','60'),(3,'Large Test','90'),(4,'Test Sheet','120'),(5,'Quiz','180');
...
CREATE TABLE `user_update` (
  `uerid` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `user_update` VALUES (1,'Nhat Duy  ','duy  ','nhatduy@gmail.com  ','2017-10-29 21:15:02'),(2,'Nhat Duy  ','1234','nhatduy@gmail.com  ','2017-10-29 21:16:52');
...
INSERT INTO `users` VALUES (1,'admin','123','nguyenquanghuy@gmail.com',1),(2,'qhuy','123','quangtuan@gmail.com  ',1),(3,'nqhuy','123','dinhthai@gmail.com  ',2),(4,'QuangLichLam','lich  ','quanglich@gmail.com  ',2),(5,'Quang Trung  ','trung  ','quangtrung@gmail.com  ',1),(6,'Hoang Hiep  ','hiep  ','hoanghiep@gmail.com  ',2),(11,'jackiebarry','123','huy@gmail.com',2);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_deleteuser`(in id varchar(45))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `pr_Khongthi` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_Khongthi`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `pr_Lietkefiledoc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_Lietkefiledoc`()
BEGIN
	select reading.readnumber,reading.readcontent,reading.option1,reading.option2,reading.option3,
	reading.option4,reading.correctanswer,reading.readtestid,ReadTest.readtestcontent
	from reading, readtest
	where reading.readtestid = readtest.readtestid;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `pr_Lietkefilenghe` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_Lietkefilenghe`()
BEGIN
	select Listening.listenid,Listening.listencontent,Listening.option1,Listening.option1,Listening.option2,
	Listening.option3,Listening.option4,ListenAudio.audio
	from Listening,ListenAudio
	where Listening.listenaudioid=ListenAudio.listenaudioid;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `pr_Tatcathi` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pr_Tatcathi`()
BEGIN
...
-- Dump completed on 2017-11-09 10:40:03
