                ...
                <div id="sidebar" class="sidebar responsive ace-save-state">
					...
					<i class="menu-icon fa fa-list"></i> <span class="menu-text">
						Questions </span> <b class="arrow fa fa-angle-down"></b>
                            ...
                            <ul class="submenu">
                                <li class=""><a href="InsertOneQuestion"> <i
							class="menu-icon fa fa-caret-right"></i> Insert One Question
					</a> <b class="arrow"></b></li>

                                <li class=""><a href="InsertQuestion"> <i
							class="menu-icon fa fa-caret-right"></i> Insert List Question
					</a> <b class="arrow"></b></li>
					...
					class="arrow fa fa-angle-down"></b>
							...
							class="menu-icon fa fa-caret-right"></i> View Result
                                    ...
                                    <ul class="submenu">
                                        <li class=""><a href="CandidateHaveExam"> <i
									class="menu-icon fa fa-caret-right"></i> List of candidates
									with exam
							</a> <b class="arrow"></b></li>

                                        <li class=""><a href="CandidateDontHaveExam"> <i
									class="menu-icon fa fa-caret-right"></i> List of candidates did
									not contest
							</a> <b class="arrow"></b></li>
                                    </ul>
                                </li>
					...
					class="menu-icon fa fa-list-alt"></i> <span class="menu-text">
						Manage Test Sheet </span> <b class="arrow fa fa-angle-down"></b>
			</a> <b class="arrow"></b>

                            <ul class="submenu">
                                <li class=""><a href="InsertQuestion"> <i
							class="menu-icon fa fa-caret-right"></i> Insert TestSheet
					</a> <b class="arrow"></b></li>

                                <li class=""><a href="UpdateDeleteTest"> <i
                ...
                <div class="main-content">
                    ...
                    <div class="main-content-inner">
                        ...
                        <div class="page-content">
                         ...
                         <form action="EditQuestion?index=${list.questionid}&pageid=1" method="post" name="frmInsertAcc">
                             <br> question number:
                             <br> <input type="text" name="questionnumber" value="${list.questionnumber }"><br>
                             <br> questioncontent:
                             <br> <input type="text" name="questioncontent" value="${list.questioncontent }"><br>
                             <br> option1:
                             <br> <input type="text" name="option1" value="${list.option1 }"><br>
                             <br> option2:
                             <br> <input type="text" name="option2" value="${list.option2 }"><br>
                             <br> option3:
                             <br> <input type="text" name="option3" value="${list.option3 }"><br>
                             <br> option4:
                             <br> <input type="text" name="option4" value="${list.option4 }"><br>
                             <br> correctanswer:
                             <br> <input type="text" name="correctanswer" value="${list.answerquestion }"><br><br>
