            ...
            <div id="navbar" class="navbar navbar-default          ace-save-state">
				...
				<span class="icon-bar"></span> <span class="icon-bar"></span>
                    ...
                    <div class="navbar-header pull-left">
                        <a href="HomeAdminForWard" class="navbar-brand"> <small> <i
                        ...
                        <div class="page-content">
                            ...
                            <div class="formInsert" style="margin:30px">
                                ...
                                <form action="#" method="post">
                                    Userid:<br> <input type="text" name="userid"><br><br> Username:
                                    <br> <input type="text" name="username"><br><br> PassWord:
                                    <br> <input type="text" name="pass"><br><br> Email:
                                    <br> <input type="text" name="fullname"><br><br> Roleid:
								...
								<option>4</option>
                                    ...
                                    <input type="submit" value="Save" style="background: skyblue;"><br>
                                </form>
                            </div>
