...
<title>Insert one question</title>
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="formInsert" style="margin:30px">
                         <h2>Insert one question</h2>
                         <div id="thongbao">
                             <p id="pthongbao"></p>
                         </div>
                         <form action="InsertOneQuestion?pageid=1" method="post" name="frmInsertAcc">
                         	 <br> question type:
                             <br> <select name ="questiontype">
                             		<option>Choose question type</option>
                             		<option>Reading</option>
                             		<option>Listening</option>
                             </select><br>
                             <br> question number:
                             <br> <input type="text" name="questionnumber" id="questionnumber" id="nav-search-input" ><br>
                             <br> questioncontent:
                             <br> <input type="text" name="questioncontent" id="questioncontent" id="nav-search-input"><br>
                             <br> option1:
                             <br> <input type="text" name="option1" id="option1" id="nav-search-input"><br>
                             <br> option2:
                             <br> <input type="text" name="option2" id="option2" id="nav-search-input"><br>
                             <br> option3:
                             <br> <input type="text" name="option3" id="option3" id="nav-search-input"><br>
                             <br> option4:
                             <br> <input type="text" name="option4" id="option4" id="nav-search-input"><br>
                             <br> correctanswer:
                             <br> <input type="text" name="correctanswer" id="correctanswer" id="nav-search-input"><br><br>
