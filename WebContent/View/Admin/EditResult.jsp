                        ...
                        <div class="page-content">
                            ...
                            <div class="ViewResult">
                                ...
                                <table border='1' style="width: 100%" class="table table-hover table-bordered table-striped">
                                    <tr>
                                        <th>resultid</th>
                                        <th>numcorrectanswerread</th>
                                        <th>numcorrectanswerlisten</th>
                                        <th>point</th>
                                        <th>testid</th>
                                        <th>userid</th>
                                        <th></th>
                                        ...
                                        <c:forEach items="${result2}" var="list">
                                            <% System.out.println(pageContext.findAttribute("list")); %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>${list.numcorrectanswerlisten}</td>
                                                    <td>${list.point}</td>
                                                    <td>${list.testid}</td>
                                                    <td>${list.userid}</td>
                                                    <td><a href="EditResult?index=${list.resultid}">Edit</a></td>
                                                    <td><a href="DeleteResult?index=${list.resultid}&pageid=1" onclick="return show_comfirm()">Delete</a></td>
                                                </tr>
                                ...
                                <ul class="pagination">
                                    ...
                                    <c:if test="${numberpage>1 && numberpage<maxpageid}">
                                        ...
                                        <li><a href="UpdateandDeleteResultpageid=1">1</a></li>
                                        <li><a href="UpdateandDeleteResult?pageid=2">2</a></li>
                                        <li><a href="UpdateandDeleteResult?pageid=${numberpage+1}">&raquo;</a></li>
                                    </c:if>
                                </ul>
