                        ...
                        <div class="page-content">
                            ...
                            <div class="" id="UpdateDeleteQuestion ">
                                ...
                                <table class="table" id="makeEditable" border='1' style="width: 100%">
                                    <tr>
                                        <th class="center">readid</th>
                                        <th class="center">readnumber</th>
                                        <th class="center">readcontent</th>
                                        <th class="center">option 1</th>
                                        <th class="center">option 2</th>
                                        <th class="center">option 3</th>
                                        <th class="center">option 4</th>
                                        <th class="center">correctanswer</th>
                                        <th class="center">readtestid</th>
                                        <th class="center">testid</th>
                                        <th></th>
                                        <th></th>
                                    </tr>
                                    <tbody id="myTable">
                                        <c:forEach items="${questions}" var="list">
                                            ...
                                            <tr>
                                                ...
                                                <td>${list.readnumber}</td>
                                                <td>${list.readcontent}</td>
                                                <td>${list.option1}</td>
                                                <td>${list.option2}</td>
                                                <td>${list.option3}</td>
                                                <td>${list.option4}</td>
                                                <td>${list.correctanswer}</td>
                                                <td>${list.readtestid}</td>
                                                <td>${list.testid}</td>
                                                <td><a href="EditQuestion?index=${list.questionid}&pageid=1">Edit</a></td>
                                                <td><a href="DeleteQuestion?index=${list.questionid}&pageid=1" onclick="return show_comfirm()">Delete</a></td>
                                            </tr>
                                ...
                                <ul class="pagination">
                                    ...
                                    <c:if test="${numberpage==maxpageid}">
                                        <li class=""><a href="UpdateDeleteQuestion?pageid=${numberpage-1}">&laquo;</a></li>
                                        <li><a href="UpdateDeleteQuestion?pageid=1">1</a></li>
                                        <li><a href="UpdateDeleteQuestion?pageid=2">2</a></li>
