<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
        ...
        <head>
            ...
            <title>Update and Delete Test Sheet</title>
            ...
            <script type="text/javascript">
                function show_comfirm() {
                    var comfirmBox;
                    comfirmBox = confirm("Bạn có chắc chắn muốn xóa bài thi này?");
                    if (comfirmBox == true) {
                        return true;
                    } else {
                        return false;
                    ...
                    <div class="main-content-inner">
                        ...
                        <div class="page-content">
                            ...
                            <div class="" id="UpdateDeleteQuestion ">
                                <h2>List Test Sheet</h2><br>
                                <table class="table" id="makeEditable" border='1' style="width: 100%">
                                    <tr>
                                        <th class="center">testid</th>
                                        <th class="center">testname</th>
                                        <th class="center">numberListen</th>
                                        <th class="center">numberRead</th>
                                        <th class="center">time</th>
                                        <th></th>
                                        <th></th>
                                    </tr>
                                    <tbody id="myTable">
                                        <c:forEach items="${testsheet}" var="list">

                                            <tr>
                                                <td>${list.testid}</td>
                                                <td>${list.testname}</td>
                                                <td>${list.numberListen}</td>
                                                <td>${list.numberRead}</td>
                                                <td>${list.time}</td>
                                                <td><a href="EditTestSheet?index=${list.testid}&pageid=1">Edit</a></td>
                                                <td><a href="DeleteTestSheet?index=${list.testid}&pageid=1" onclick="return show_comfirm()">Delete</a></td>
                                            </tr>
