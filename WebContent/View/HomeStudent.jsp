<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  ==================================================-->
                ...
                <div id="myCarousel" class="carousel slide">
                        ...
                        <div class="active item">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="span6">
                                        <img src="Template/Fontend/img/slide/good.jpg" height="400px">
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="span6">
                                            <img src="Template/Fontend/img/slide/${list.slidebannerimage}" height="400px">
                                        </div>
                    ...
                    <!-- Carousel nav -->
                    <a class="carousel-control left " href="#myCarousel" data-slide="prev"><i class="icon-chevron-left"></i></a> <a class="carousel-control right" href="#myCarousel" data-slide="next"><i
  ...
  ==============================================-->
                ...
                <div class="row feature-box">
                    ...
                    <div class="span4">
                        <a href="QuizForward"> <img
					src="Template/Fontend/img/test_1.png" onclick="countdownTimer()">
				</a>
                        <h2>Thi thử TOEIC</h2>
                        <p>Các bạn học viên có thể đăng ký vào hệ thống và được thi thử TOEIC
                        </p>

                    </div>

                    <div class="span4">
                        <a href="Vocabulary"> <img src="Template/Fontend/img/vocabulary.JPG">
				</a>
                        <h2>Một số từ vựng cơ bản</h2>
                        <p>Một số từ vựng của TOEIC thông dụng</p>
                    </div>

                    <div class="span4">
                        <a href="https://www.youtube.com/watch?v=Dnno-I0LVQM" target="_blank"> <img src="Template/Fontend/img/music.png">
				</a>
                        <h2>Nhạc tiếng anh</h2>
                        <p>Những bài nhạc tiếng anh hay nhất mọi thời đại.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="span6">
                        <img src="Template/Fontend/img/background.jpg">
                    </div>
